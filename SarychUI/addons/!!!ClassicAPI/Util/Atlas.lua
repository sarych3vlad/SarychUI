...
local TEXTURE_PATH = Private.TEXTURE_PATH
...
local FrameGeneral_UIFrameDiamondMetal = TEXTURE_PATH.."FrameGeneral\\UIFrameDiamondMetal"
...
local FrameGeneral_UIFrameDiamondMetalVertical = TEXTURE_PATH.."FrameGeneral\\UIFrameDiamondMetalVertical"
...
local RaidFrame_RaidFrameSummon = TEXTURE_PATH.."RaidFrame\\RaidFrameSummon"
...
local ContainerFrame_Bags = TEXTURE_PATH.."ContainerFrame\\Bags"
