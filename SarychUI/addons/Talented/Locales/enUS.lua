...
L["Reset"] = true
L["Apply"] = true
L["Are you sure you want to learn the selected talents?"] = true
L["Are you sure you want to apply this template?"] = true
L["Confirm and learn the selected talents."] = true
L["Apply this template to your talents."] = true
L["Reset preliminary talent allocation."] = true
L["Reset template changes from this edit."] = true
