...
function ClassIcon:CreateFrame(unit)
    ...
    self.frame[unit].texture_border:SetTexture([[Interface\AddOns\SarychUI\addons\GladiusEx\media\icon_border]])
...
function ClassIcon:Update(unit)
    ...
    self.frame[unit]:SetNormalTexture([[Interface\AddOns\SarychUI\addons\GladiusEx\media\gloss]])
