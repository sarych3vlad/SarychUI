...
function CastBar:CreateBar(unit)
    ...
    self.frame[unit].icon.shield:SetTexture([[Interface\AddOns\SarychUI\addons\GladiusEx\media\shield]])

    self.frame[unit].spark = self.frame[unit].bar:CreateTexture(nil, "OVERLAY")
    self.frame[unit].spark:SetTexture([[Interface\AddOns\SarychUI\addons\GladiusEx\media\spark]])
