...
function E:SetMoverLayoutPositionPoint(mover, name, frame)
	local layouts = E.LayoutMoverPositions or { ALL = {} }
	local layout = E.db and E.db.layoutSetting and layouts[E.db.layoutSetting]
	mover.point = (layout and layout[name]) or (layouts.ALL and layouts.ALL[name]) or GetPoint(frame)
end
