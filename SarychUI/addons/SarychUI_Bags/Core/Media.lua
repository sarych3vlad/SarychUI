...
local M = [[Interface\AddOns\SarychUI\addons\SarychUI_Bags\Media\]]
...
E.Media = {
	...
	Textures = {
		...
		Black8x8 = [[Interface\Buttons\WHITE8X8]],
		...
		NormTex = [[Interface\TargetingFrame\UI-StatusBar]],
		NormTex2 = [[Interface\TargetingFrame\UI-StatusBar]],
		...
		StreamBackground = M..[[Textures\StreamBackground.blp]],
		StreamCircle = M..[[Textures\StreamCircle.blp]],
		StreamFrame = M..[[Textures\StreamFrame.blp]],
		StreamSpark = M..[[Textures\StreamSpark.blp]],
...
LSM:Register("font", "Arial Narrow", [[Fonts\ARIALN.TTF]], LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
...
function E:UpdateMedia()
	...
	self.media.bordercolor = border and {border.r, border.g, border.b} or {0, 0, 0}
	self.media.unitframeBorderColor = self.media.bordercolor

	local backdrop = db and db.backdropcolor
	self.media.backdropcolor = backdrop and {backdrop.r, backdrop.g, backdrop.b} or {0.06, 0.06, 0.06}

	local fade = db and db.backdropfadecolor
	self.media.backdropfadecolor = fade and {fade.r, fade.g, fade.b, fade.a or 0.8} or {0.06, 0.06, 0.06, 0.8}

	local value = db and db.valuecolor
	self.media.rgbvaluecolor = value and {value.r, value.g, value.b} or {0.99, 0.48, 0.17}
