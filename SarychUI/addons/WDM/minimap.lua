...
function MM:OnEnable()
    if self.db.profile["show_minimap"] then
        ...
        MiniMapWorldMapButton:SetNormalTexture(WDM_GetTexturePath("ui-minimap-worldmapsquare"))
        MiniMapWorldMapButton:SetPushedTexture(WDM_GetTexturePath("ui-minimap-worldmapsquare"))
