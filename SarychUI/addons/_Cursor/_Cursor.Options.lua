...
do
	...
	-- SarychUI: register in Blizzard options only when embedded addon is enabled.
	function me.RegisterInterfaceOptions()
		if me._suiRegistered then
			return
		end
		InterfaceOptions_AddCategory( me );
		me._suiRegistered = true;
	end
