...
function FindGroup_AchieveIcon_Enter(this)
	...
	this:SetNormalTexture("Interface\\AddOns\\SarychUI\\addons\\FindGroup\\textures\\UI-GROUP-ACHIEV1")
end

function FindGroup_AchieveIcon_Leave(this)
	this:SetNormalTexture("Interface\\AddOns\\SarychUI\\addons\\FindGroup\\textures\\UI-GROUP-ACHIEV0")
end
...
function FindGroup_QuestIcon_Enter(this)
	...
	--this:SetNormalTexture("Interface\\AddOns\\SarychUI\\addons\\FindGroup\\textures\\UI-GROUP-QUEST1")
end

function FindGroup_QuestIcon_Leave(this)
	--this:SetNormalTexture("Interface\\AddOns\\SarychUI\\addons\\FindGroup\\textures\\UI-GROUP-QUEST0")
end
