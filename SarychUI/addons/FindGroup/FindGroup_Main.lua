...
msgevent:SetScript("OnEvent", function(self, event, prefix, msg, type, sender)
	if SarychUI_FindGroupIsActive and not SarychUI_FindGroupIsActive() then
		return
	end
...
FindGroupFramePinButton:SetNormalTexture("Interface\\AddOns\\SarychUI\\addons\\FindGroup\\textures\\LockButton-Unlocked-Up.tga")
FindGroupFramePinButton:SetPushedTexture("Interface\\AddOns\\SarychUI\\addons\\FindGroup\\textures\\LockButton-Unlocked-Down.tga")

else
	FGL.db.pinstatus = 1
	FindGroupFrame:SetMovable("fulse")
FindGroupFramePinButton:SetNormalTexture("Interface\\AddOns\\SarychUI\\addons\\FindGroup\\textures\\LockButton-Locked-Up.tga")
FindGroupFramePinButton:SetPushedTexture("Interface\\AddOns\\SarychUI\\addons\\FindGroup\\textures\\LockButton-Locked-Down.tga")
end
...
function FindGroup_AlarmButton()
	if FGL.db.alarmstatus == 1 then
		...
		FindGroupFrameAlarmButton:SetNormalTexture("Interface\\AddOns\\SarychUI\\addons\\FindGroup\\textures\\UI-Panel-SoundOff-Up.tga")
		FindGroupFrameAlarmButton:SetPushedTexture("Interface\\AddOns\\SarychUI\\addons\\FindGroup\\textures\\UI-Panel-SoundOff-Down.tga")
	else
		FGL.db.alarmstatus = 1
		FindGroupFrameAlarmButton:SetNormalTexture("Interface\\AddOns\\SarychUI\\addons\\FindGroup\\textures\\UI-Panel-SoundOn-Up.tga")
		FindGroupFrameAlarmButton:SetPushedTexture("Interface\\AddOns\\SarychUI\\addons\\FindGroup\\textures\\UI-Panel-SoundOn-Down.tga")
	end
...
local frameVisible = FindGroupFrame and FindGroupFrame:IsVisible()
FGL.db.lastmsg={}
FGL.db.nummsgsmax = 0
...
if frameVisible and FGL.db.nummsgsmax > 0 then FindGroup_printmsgtext(1) end
end
...
function FindGroup_ClearText(i)
 	FGL.db.lastmsg[i]={}
	if SarychUI_FindGroupQueueRefresh then
		SarychUI_FindGroupQueueRefresh()
	else
