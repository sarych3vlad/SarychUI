...
function OmniBar:RegisterInterfaceOptions()
	if self._suiBlizRegistered then
		return
	end
	if self.EnsureRuntimeInit then
...
export:SetWidth(550)
if export.frame then
	export.frame:SetResizable(false)
end
...
import:SetWidth(550)
if import.frame then
	import.frame:SetResizable(false)
end
