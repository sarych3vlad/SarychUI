-- Позиция
_G["CentrY"] = 47
_G["CastX"] = 50 -- справа от controlFrame
_G["CastY"] = 0
_G["RightX"] = 5
_G["RightY"] = -10
_G["OtherX"] = 35 -- справа от mobilityFrame
_G["OtherY"] = 0
_G["PlayerOffsetY"] = -7 -- расстояние между CONTROL/CAST и PLAYER фреймами

-- Размеры
_G["ICON_SIZE_CONTROL"] = 46 -- controlFrame по центру
_G["ICON_SIZE_CAST"] = 46 -- castFrame справа от controlFrame
_G["ICON_SIZE_MOBILITY"] = 30 -- mobilityFrame справа
_G["ICON_SIZE_OTHER"] = 30 -- otherFrame рядом с mobilityFrame
_G["PLAYER_ICON_SPACING"] = 2 -- расстояние между иконками способностей игрока
_G["PLAYER_ALT_RIGHT"] = false -- способности игрока справа над «прочие»/«рывки», по 2 в ряд
_G["ICON_SIZE_PLAYER"] = 28 -- playerFrame под основным
_G["ICON_SIZE_PLAYER_WIDTH"] = 30 -- ширина иконок playerFrame
_G["ICON_SIZE_PLAYER_HEIGHT"] = 20 -- высота иконок playerFrame

-- Количество отображаемых аур
_G["MAX_PLAYER_AURAS"] = 6
_G["MAX_AURAS"] = 1
...
_G["SPELL_DATA"] = {
    ...
    [34490] = { type = "silence", priority = 3, highlight = 4 }, -- Silencing Shot
    ...
    -- Mage
    [45438] = { type = "cc", priority = 1, highlight = 1 }, -- Ice Block
    ...
    -- Paladin
    [642] = { type = "cc", priority = 1 }, -- Divine Shield
    ...
    [47486] = { type = "other", priority = 1, highlight = 3 }, -- Смертельный удар
    -- Misc
    ...
    -- CAST группа - заклинания для отображения
    -- Death Knight
    [47528] = { type = "cast", priority = 1 }, -- Mind Freeze
    [47541] = { type = "cast", priority = 2 }, -- Death Coil
    [55050] = { type = "cast", priority = 3 }, -- Heart Strike
    
    -- Druid
    [339] = { type = "cast", priority = 1 }, -- Entangling Roots
    [8936] = { type = "cast", priority = 2 }, -- Regrowth
    [5185] = { type = "cast", priority = 3 }, -- Healing Touch
    
    -- Hunter
    [75] = { type = "cast", priority = 1 }, -- Auto Shot
    [1978] = { type = "cast", priority = 2 }, -- Serpent Sting
    [3044] = { type = "cast", priority = 3 }, -- Arcane Shot
    
    -- Mage
    [116] = { type = "cast", priority = 1 }, -- Frostbolt
    [133] = { type = "cast", priority = 2 }, -- Fireball
    [5143] = { type = "cast", priority = 3 }, -- Arcane Missiles
    
    -- Paladin
    [635] = { type = "cast", priority = 1 }, -- Holy Light
    [19750] = { type = "cast", priority = 2 }, -- Flash of Light
    [20271] = { type = "cast", priority = 3 }, -- Judgement
    
    -- Priest
    [2060] = { type = "cast", priority = 1 }, -- Greater Heal
    [2061] = { type = "cast", priority = 2 }, -- Flash Heal
    [17] = { type = "cast", priority = 3 }, -- Power Word: Shield
    
    -- Rogue
    [1752] = { type = "cast", priority = 1 }, -- Sinister Strike
    [53] = { type = "cast", priority = 2 }, -- Backstab
    [8676] = { type = "cast", priority = 3 }, -- Ambush
    
    -- Shaman
    [331] = { type = "cast", priority = 1 }, -- Healing Wave
    [8004] = { type = "cast", priority = 2 }, -- Lesser Healing Wave
    [403] = { type = "cast", priority = 3 }, -- Lightning Bolt
    
    -- Warlock
    [686] = { type = "cast", priority = 1 }, -- Shadow Bolt
    [5019] = { type = "cast", priority = 2 }, -- Shoot
    [5782] = { type = "cast", priority = 3 }, -- Fear
    
    -- Warrior
    [772] = { type = "cast", priority = 1 }, -- Rend
    [6673] = { type = "cast", priority = 2 }, -- Battle Shout
    [5242] = { type = "cast", priority = 3 }, -- Intimidating Shout
